...
import { Route, useNavigate, Routes, Navigate, Link, Redirect } from "react-router-dom";
    ...
    return (
        <Suspense fallback="loading...">
            <Routes>
                ...
                <Route path='/' element={<LoginCompo onForgotPassword={forgotPasswordHandler} />} ></Route>
                <Route path='/forgot-password' element={<ForgotPasswordCompo />}></Route>
            </Routes>
        </Suspense>
    )
}
