      ...
      <form>
        ...
        <div className="row">
          <div className="col-md-12 mt-3">
            <RdsCheckbox label="Required Non Alpha Numeric Characters"></RdsCheckbox>
          </div>
        </div>
        <div className="row">
          <div className="col-md-12 mt-3">
            <RdsCheckbox label="Required Upper Case"></RdsCheckbox>
          </div>
        </div>
        <div className="row">
          <div className="col-md-12 mt-3">
            <RdsCheckbox label="Required Lower Case"></RdsCheckbox>
          </div>
        </div>
        <div className="row">
          <div className="col-md-12 mt-3">
            <RdsCheckbox label="Required Numbers"></RdsCheckbox>
          </div>
        </div>
        {/* Lockout Settings */}
