...
const RdsCompTenantSettings =(props:RdsCompTenantSettingsProps) =>{
    ...
    <div>
            ...
            <form>
             ...
             <div className="row mb-3">
                 <div className="col-md-6 sm-p-0" >
                     <div className="form-group mb-3">
                         <RdsInput inputType='password' placeholder='Password' label='Password' name='password'></RdsInput>
                 ...
                 <div className="col-md-6 sm-p-0">
                     <div className="form-group mb-3">
                        <RdsInput inputType='password' placeholder='Confirm Password' label='Confirm Password' name='cpassword'></RdsInput>
        ...
        <div className="footer-buttons my-2">
            ...
            <RdsButton tooltipTitle={''} type={'button'} label="Save" size='small' colorVariant='primary' class='ms-2'></RdsButton>
