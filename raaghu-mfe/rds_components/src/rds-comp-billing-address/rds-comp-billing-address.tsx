...
const RdsCompBillingAddress = (props: RdsCompBillingAddressProps) => {
    ...
    const [stateProvinceErrorMessage, setProvinceStateErrorMessage] = useState<string>("")



    //Validation functions
    const firstNameValidation = (firstName: string) => {
        firstName === "" ? setFirstNameErrorMessage("First Name is required") : setFirstNameErrorMessage("");
        console.log("hello everyone     " + firstName)
    }
    const lastNameValidation = (lastName: string) => {
        lastName === "" ? setLastNameErrorMessage("Last Name is required") : setLastNameErrorMessage("")
    }
    ...
    const addressValidation = (address: string) => {
        address === "" ? setAddressErrorMessage("Address is required") : setAddressErrorMessage("")
    }
    const cityValidation = (city: string) => {
        city === "" ? setCityErrorMessage("City is required") : setCityErrorMessage("")
    }
    const countryValidation = (country: string) => {
        (country === "Select Country") ? setCountryErrorMessage("Country is required") : setCountryErrorMessage("")
    }
    const stateProvinceValidation = (state: string) => {
        (state === "Select Country") ? setProvinceStateErrorMessage("State/Province is required") : setProvinceStateErrorMessage("")
    }
                ...
                <form id="billingAddressForm" onSubmit={onSubmitHandler}>
                    ...
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            ...
                            />
                            {stateProvinceErrorMessage != "" && <div className="form-control-feedback">
                                <span className="text-danger">{stateProvinceErrorMessage}</span>
                            </div>}
                        </div >
                        <div className="col-md-6 mb-3">
                            <RdsInput
