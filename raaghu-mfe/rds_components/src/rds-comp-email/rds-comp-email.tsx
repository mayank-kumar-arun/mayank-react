    ...
    <>
      <form>
        <div className="row mb-3">
          <div className="col-md-6 col-sm-6 col-lg-6">
            <div className="form-group">
              ...
              ></RdsInput>
              {error && <h2 style={{color: 'red', fontSize:"15px", marginTop:"5px"}}>{error}</h2>}
            </div>
          </div>
          <div className="col-md-6 col-sm-6 col-lg-6">
            <RdsLabel
        ...
        <div className="row mb-3">
          <div className="col-md-6 col-sm-6 col-lg-6">
            <div className="form-group">
              <RdsLabel label="SMTP Host" className="mb-1" size="14px"></RdsLabel>
              <RdsInput
        ...
        <div className="row mb-3">
          <div className="col-lg-12 col-md-12 col-sm-12" style={{fontSize: "14px"}}>
            <RdsCheckbox label="Use SSL"></RdsCheckbox>
          </div>
        </div>
        ...
        <div className="row mb-3">
          <div className="col-md-6 col-sm-6 col-lg-6">
            <div className="form-group">
              <RdsLabel label="Test Email Settings" className="mb-1" size="14px"></RdsLabel>
              <RdsInput
          ...
          <div className="col-md-6 col-sm-6 col-lg-6 pt-4">
                <RdsButton type="submit" label="SEND TEST EMAIL" colorVariant="primary"></RdsButton>
          </div>
        </div>
      </form>
    </>
