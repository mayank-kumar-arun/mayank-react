  ...
  return (
    <>
      <button
        ...
        data-bs-target={`${props.staticbackdrop?"#staticBackdrop":"#exampleModal"}`}
      >
        {props.label}
      </button>
      ...
      {!props.staticbackdrop && <div
        ...
        tabIndex={-1}
        aria-labelledby={`${props.staticbackdrop?"staticBackdropLabel":"exampleModalLabel"}`}
        aria-hidden="true"
      >
        <div className={`modal-dialog ${props.scrollable?"modal-dialog-scrollable":""} ${props.verticallyCentered?" modal-dialog-centered":""}`}>
          <div className="modal-content">
            {props.showModalHeader && (
              <div className="modal-header">
                <h5 className="modal-title" id={`${props.staticbackdrop?"staticBackdropLabel":"exampleModalLabel"}`}>
