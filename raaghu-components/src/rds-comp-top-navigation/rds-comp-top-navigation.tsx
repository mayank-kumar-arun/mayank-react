			...
			>
				...
				<div className="d-flex me-2 align-items-center">
					...
					<RdsOffcanvas
						...
						</div>} backDrop={true} scrolling={false} preventEscapeKey={false} canvasTitle={""} onclick={function (data: any): void {
					...
					{LinkAccount && <RdsOffcanvas placement="end" offId="linkaccount" backDrop={false} scrolling={false} preventEscapeKey={false} canvasTitle={""} offcanvaswidth={400} onclick={function (data: any): void {
						throw new Error("Function not implemented.");
					} } >
